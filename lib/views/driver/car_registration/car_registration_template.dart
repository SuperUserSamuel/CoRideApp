...
import 'package:corideapp/views/driver/car_registration/pages/document_uploaded_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/location_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/upload_document_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_color_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_make.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_model_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_model_year_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_number_page.dart';
import 'package:corideapp/views/driver/car_registration/pages/vehical_type_page.dart';
...
class _CarRegistrationTemplateState extends State<CarRegistrationTemplate> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Vehicle Registration'),),
      body: Column(
        children: [

          greenIntroWidgetWithoutLogos(title: 'Car Registration',
              subtitle: 'Complete the process detail', context: context),
