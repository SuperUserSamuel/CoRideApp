...
class _MyProfileState extends State<MyProfile> {
  ...
  void initState() {
    ...
    super.initState();
    nameController.text = "Samuel Airadion";
    homeController.text = "4a Volta Street";
    shopController.text = "4a Volta Street";
    businessController.text = "4a Volta Street";

    homeAddress = LatLng(37.42796133580664, -122.085749655962);
    businessAddress = LatLng(37.42796133580664, -122.085749655962);
    shoppingAddress = LatLng(37.42796133580664, -122.085749655962);
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  greenIntroWidgetWithoutLogos(title: 'My Profile', context: context),
                  Align(
