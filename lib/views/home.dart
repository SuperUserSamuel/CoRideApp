...
import 'package:corideapp/views/ride_booking/post_ride.dart';
    ...
    return Positioned(
      ...
      child: Padding(
        ...
        child: SizedBox(
          height: 200.h,
          child: Card(
            margin: EdgeInsets.symmetric(horizontal: 10, vertical: 64.h),
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => PostRide()),
                      );
                    }, icon: Icon(Icons.add),
                  ),
                ),
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              ...
              // sourceController.text = 'Thames Street Maitama';
              // String place = 'Thames Street Maitama';
              //
              // if (markers.length >= 2) {
              //   markers.remove(markers.last);
              // }
